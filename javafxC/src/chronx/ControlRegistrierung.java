...
public class ControlRegistrierung {
    ...
    void zurueckClick(ActionEvent event) throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/chronx/Anmeldung.fxml"));
    ...
    void registrierenClick(ActionEvent event)  throws IOException {
        ...
        if (counter == 3){ 
            ...
            Parent root = FXMLLoader.load(getClass().getResource("/chronx/RegistrierungAbgeschlossen.fxml"));
            stage = (Stage)((Node)event.getSource()).getScene().getWindow();
            scene = new Scene(root);
            stage.setScene(scene);
            stage.show(); 
