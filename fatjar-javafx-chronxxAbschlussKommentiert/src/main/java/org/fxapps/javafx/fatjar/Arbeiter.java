...
//Pojo fuer das Parser der Jsondatei
public class Arbeiter {
	...
	@JsonProperty
	List<List<LocalDateTime>> zeitarbeitsTag = new ArrayList<List<LocalDateTime>>(); // Monat, Tag, einzelne Zeiten.
																						// Dennoch sind alle Zeitsaetze
																						// mit allen Infos ausgestattet
