...
public class ControlStartseite implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        if (warngrenzePerson - gleitzeitPerson  > 20) {
        ...
        else if (warngrenzePerson - gleitzeitPerson <= 20 && warngrenzePerson - gleitzeitPerson > 0) {
    ...
    public void sts4 (MouseEvent event) throws IOException {
        ...
        Parent root2 = FXMLLoader.load(getClass().getResource("/application/Anmeldung.fxml"));
    ...
    void gleitzeitClick(MouseEvent event) throws IOException {
        ...
        Parent root2 = FXMLLoader.load(getClass().getResource("/application/Zeiterfassung.fxml"));
        stage = (Stage)((Node)event.getSource()).getScene().getWindow();
        scene = new Scene(root2);
        stage.setScene(scene);
